...
def main(args: argparse.Namespace):
    ...
    for i in range(5):
        ...
        for epoch in range(args.epochs):
            ...
            #if best_test_acc1 < utils.validate(test_loader, classifier, args, device) and best_test_acc1 > 80:
            #    a = utils.test_visualization(test_loader, classifier, args, device, save_path='/home/iai/Desktop/SH/transfer_library/Transfer-Learning-Library/examples/domain_generalization/image_classification/logs/mixstyle/Cognex/visualize/oracle_')        
