...
#멀티소스
CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_cameraz Custom_light Custom_bright Custom_blur -t Repeat Brightness Cameraz Lcondition -a resnet50 --lr 0.01 --log logs/ibn/Cognex

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz Custom_flip -t Repeat Brightness Cameraz Lcondition -a resnet50_ibn_b --lr 0.01 --log logs/ibn/Cognex




CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz Custom_flip -t Repeat Brightness Cameraz Lcondition -a resnet50_ibn_b --lr 0.01 --log logs_final_multi/ibn/Cognex

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz Custom_flip -t Repeat -a resnet50_ibn_b --lr 0.01 --log logs_final_multi/ibn/Cognex  -b 4 --phase test
CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz Custom_flip -t Brightness Cameraz Lcondition -a resnet50_ibn_b --lr 0.01 --log logs_final_multi/ibn/Cognex  -b 4 --phase test

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat -t Default_test -a resnet50_ibn_b --lr 0.01 --log logs_final_multi/ibn/Cognex  -b 4 --phase test
CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat -t Non_Default_test -a resnet50_ibn_b --lr 0.01 --log logs_final_multi/ibn/Cognex  -b 4 --phase test


CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat -t Repeat Brightness Cameraz Lcondition -a resnet50_ibn_b --lr 0.01 --log logs_final_single/ibn/Cognex

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat -t Default_test -a resnet50_ibn_b --lr 0.01 --log logs_final_single/ibn/Cognex  -b 4 --phase test
CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat -t Non_Default_test -a resnet50_ibn_b --lr 0.01 --log logs_final_single/ibn/Cognex  -b 4 --phase test