...
#멀티소스
CUDA_VISIBLE_DEVICES=0 python coral.py data/Cognex -d Cognex -s Custom_repeat Custom_cameraz Custom_light Custom_bright Custom_blur -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/coral/Cognex


CUDA_VISIBLE_DEVICES=0 python coral.py data/Cognex -d Cognex -s Custom_repeat Custom_light -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/coral/Cognex --n-domains-per-batch 2


CUDA_VISIBLE_DEVICES=0 python coral.py data/Cognex -d Cognex -s Custom_repeat Custom_dropout -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/coral/Cognex --n-domains-per-batch 2 --lr 0.01


CUDA_VISIBLE_DEVICES=0 python coral.py data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/coral/Cognex --n-domains-per-batch 2 --lr 0.01