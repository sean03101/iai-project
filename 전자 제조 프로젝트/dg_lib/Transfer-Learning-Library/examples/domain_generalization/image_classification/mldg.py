...
def main(args: argparse.Namespace):
    ...
    utils.test_visualization(test_loader, classifier, args, device, save_path='/home/iai/Desktop/SH/transfer_library/Transfer-Learning-Library/examples/domain_generalization/image_classification/logs/mldg/Cognex/visualize/')
...
if __name__ == '__main__':
    ...
    # training parameters
    parser.add_argument('--n-support-domains', type=int, default=2,
