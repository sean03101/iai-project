...
#멀티소스
CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_cameraz Custom_light Custom_bright Custom_blur -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/erm/Cognex --lr 0.01

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_contrast Custom_dropout Custom_flip -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/erm/Cognex --lr 0.01


CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_flip -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/erm/Cognex --lr 0.01

CUDA_VISIBLE_DEVICES=0 python erm.py data/Cognex -d Cognex -s Custom_repeat Custom_bright custom_cameraz -t Repeat Brightness Cameraz Lcondition -a resnet50 --log logs/erm/Cognex --lr 0.01