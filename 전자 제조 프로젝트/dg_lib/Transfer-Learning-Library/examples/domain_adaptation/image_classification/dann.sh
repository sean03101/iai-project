...
#Cognex
CUDA_VISIBLE_DEVICES=0 python dann.py /home/iai/Desktop/SH/transfer_library_cognex/Transfer-Learning-Library/examples/domain_generalization/image_classification/data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz -t Custom_repeat -a resnet50 --epochs 100 --log logs/dann/Cognex --lr 0.01


#Cognex
CUDA_VISIBLE_DEVICES=0 python dann.py /home/iai/Desktop/SH/transfer_library_cognex/Transfer-Learning-Library/examples/domain_generalization/image_classification/data/Cognex -d Cognex -s Custom_repeat Custom_bright -t Custom_repeat -a resnet50 --epochs 100 --log logs/dann/Cognex --lr 0.01
CUDA_VISIBLE_DEVICES=0 python dann.py /home/iai/Desktop/SH/transfer_library_cognex/Transfer-Learning-Library/examples/domain_generalization/image_classification/data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz -t Repeat Brightness Cameraz Lcondition -a resnet50 --epochs 100 --log logs/dann/Cognex --lr 0.01 --phase test


CUDA_VISIBLE_DEVICES=0 python dann.py /home/iai/Desktop/SH/transfer_library_cognex/Transfer-Learning-Library/examples/domain_generalization/image_classification/data/Cognex -d Cognex -s Custom_repeat Custom_bright Custom_cameraz Custom_flip Custom_light Custom_contrast Custom_blur -t Custom_repeat -a resnet50 --epochs 100 --log logs/dann/Cognex --lr 0.01