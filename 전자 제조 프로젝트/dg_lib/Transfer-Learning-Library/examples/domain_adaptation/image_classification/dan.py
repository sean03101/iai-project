...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'test':
        ...
        utils.test_visualization(test_loader, classifier, args, device, save_path='/home/iai/Desktop/SH/transfer_library/Transfer-Learning-Library/examples/domain_adaptation/image_classification/logs/dan/Cognex/visualize/')
        print(acc1)
        return
